...
`);
export function tsconfigSuggestions(config) {
...
export function parseContent(contents, filename) {
...
export function rawToTsCompilerOptions(jsonOptions, projectDir, tsImpl) {
